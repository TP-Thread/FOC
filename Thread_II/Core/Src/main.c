...
{
    HAL_UART_Transmit(&huart3, (uint8_t *)buffer, size, 10);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : SD4_Pin SD2_Pin SD3_Pin LCD_CS_Pin */
  GPIO_InitStruct.Pin = SD4_Pin|SD2_Pin|SD3_Pin|LCD_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
